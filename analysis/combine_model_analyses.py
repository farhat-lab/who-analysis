...
# keep variants with an FDR-corrected p-value < 0.05 for tier1 genes and < 0.01 for tier1+2 models. 
merged_significant = merged_df.loc[((merged_df["Tier1_only"] == 1) & (merged_df["BH_pval"] < 0.05)) |
