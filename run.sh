...
for i in ${!drug_array[@]}; do 
  ...
  python3 -u 02_regression_with_bootstrap config.yaml "${drug_array[$i]}" "${abbr_array[$i]}"
...
for i in ${!drug_array[@]}; do 
  ...
  python3 -u 02_regression_with_bootstrap config_AF.yaml "${drug_array[$i]}" "${abbr_array[$i]}"
...
for i in ${!drug_array[@]}; do 
  ...
  python3 -u 02_regression_with_bootstrap config_tiers12.yaml "${drug_array[$i]}" "${abbr_array[$i]}"
