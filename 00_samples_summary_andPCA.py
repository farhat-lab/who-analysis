...
_, input_data_dir, mixed_sites_thresh = sys.argv
...
np.save("data/20230226_pca_explained_var", pca.explained_variance_ratio_)
...
eigenvec_df.to_csv(f"data/20230226_eigenvec_{num_PCs}PC.csv")
